...
///
/// Without a plugin the installer ships no runtime sources, so `Plain` suits
/// only a fixture with nothing the emitter renders as a runtime type (such as
/// `Bytes`, #130).
...
#[test]
fn test_that_kotlin_code_with_a_uuid_compiles() {
