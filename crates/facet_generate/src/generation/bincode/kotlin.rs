...
fn write_serialize<W: IndentWrite>(
    ...
    match format {
        ...
        Format::U8 => writeln!(w, "serializer.serialize_u8({field_name}.toByte())"),
        Format::U16 => writeln!(w, "serializer.serialize_u16({field_name}.toShort())"),
        Format::U32 => writeln!(w, "serializer.serialize_u32({field_name}.toInt())"),
        Format::U64 => writeln!(w, "serializer.serialize_u64({field_name}.toLong())"),
