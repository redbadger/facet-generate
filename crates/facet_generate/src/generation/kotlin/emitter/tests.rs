...
fn unit_struct_1() {
    ...
    let actual = emit!(UnitStruct as Kotlin).unwrap();
...
fn newtype_struct() {
    ...
    let actual = emit!(NewType as Kotlin).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn tuple_struct() {
    ...
    let actual = emit!(TupleStruct as Kotlin).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn struct_with_fields_of_primitive_types() {
    ...
    let actual = emit!(StructWithFields as Kotlin).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn struct_with_fields_of_user_types() {
    ...
    let actual = emit!(Outer as Kotlin).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn enum_with_unit_variants() {
    ...
    let actual = emit!(EnumWithUnitVariants as Kotlin).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn enum_with_unit_struct_variants() {
    ...
    let actual = emit!(MyEnum as Kotlin).unwrap();
    insta::assert_snapshot!(actual, @"
...
impl EmitterPlugin<Kotlin> for AfterTypeProbe {
...
#[test]
fn after_type_fires_once_for_a_data_class() {
    #[derive(Facet)]
    struct Point {
        x: i32,
    }

    let actual = emit!(Point as Kotlin with AfterTypeProbe).unwrap();
    insta::assert_snapshot!(actual, @"
...
#[test]
fn after_type_fires_once_for_an_enum_class() {
    #[derive(Facet)]
    #[repr(C)]
    enum Flag {
        On,
    ...
    let actual = emit!(Flag as Kotlin with AfterTypeProbe).unwrap();
    insta::assert_snapshot!(actual, @"
...
#[test]
fn after_type_fires_once_for_a_sealed_interface_not_per_variant() {
    #[derive(Facet)]
    #[repr(C)]
    ...
    let actual = emit!(Shape as Kotlin with AfterTypeProbe).unwrap();
    insta::assert_snapshot!(actual, @"
