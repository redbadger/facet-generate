...
fn struct_with_fields_of_primitive_types() {
    ...
    data class StructWithFields(
        ...
        fun serialize(serializer: Serializer) {
            ...
            serializer.serialize_u8(u8.toByte())
            serializer.serialize_u16(u16.toShort())
            serializer.serialize_u32(u32.toInt())
            serializer.serialize_u64(u64.toLong())
...
fn struct_with_field_that_is_a_3_tuple() {
    ...
    data class MyStruct(
        ...
        fun serialize(serializer: Serializer) {
            ...
            serializer.serialize_str(one.first)
            serializer.serialize_i32(one.second)
            serializer.serialize_u16(one.third.toShort())
            serializer.decrease_container_depth()
        }
...
fn struct_with_field_that_is_a_4_tuple() {
    ...
    data class MyStruct(
        ...
        fun serialize(serializer: Serializer) {
            ...
            serializer.serialize_u16(one.component3().toShort())
    ...
    sealed interface MyEnum {
        ...
        data class Variant2(
            ...
            override fun serialize(serializer: Serializer) {
                ...
                serializer.serialize_u8(field2.toByte())
                serializer.decrease_container_depth()
            }
    ...
    data class MyStruct(
        ...
        fun serialize(serializer: Serializer) {
            ...
            optionalBytes.serializeOptionOf(serializer) { level1 ->
                level1.serialize(serializer) {
                    serializer.serialize_u8(it.toByte())
                }
            }
            serializer.decrease_container_depth()
        }
