...
fn unit_struct_1() {
    ...
    let actual = emit!(UnitStruct as Swift).unwrap();
...
fn newtype_struct() {
    ...
    let actual = emit!(NewType as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn tuple_struct() {
    ...
    let actual = emit!(TupleStruct as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn struct_with_fields_of_primitive_types() {
    ...
    let actual = emit!(StructWithFields as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn struct_with_fields_of_user_types() {
    ...
    let actual = emit!(Outer as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn enum_with_unit_variants() {
    ...
    let actual = emit!(EnumWithUnitVariants as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn enum_with_unit_struct_variants() {
    ...
    let actual = emit!(MyEnum as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
...
fn namespaced_child() {
    ...
    let actual = emit!(Parent as Swift).unwrap();
    insta::assert_snapshot!(actual, @"
