...
public abstract class OtherParent {
    ...
    public static final class Child extends OtherParent {
        public final com.example.other.other.OtherChild value;

        public Child(com.example.other.other.OtherChild value) {
        ...
        static Child load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            ...
            builder.value = com.example.other.other.OtherChild.deserialize(deserializer);
        ...
        public static final class Builder {
            public com.example.other.other.OtherChild value;
