...
public final class Child {
    public final com.example.other.OtherParent external;

    public Child(com.example.other.OtherParent external) {
    ...
    public static Child deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        builder.external = com.example.other.OtherParent.deserialize(deserializer);
    ...
    public static final class Builder {
        public com.example.other.OtherParent external;
