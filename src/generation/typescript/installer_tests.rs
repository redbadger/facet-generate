...
fn manifest_with_dependencies() {
    ...
    let installer = Installer::new_with_external_packages(install_dir.path(), &external_packages);
...
fn manifest_with_external_namespace_dependencies() {
    ...
    let mut installer =
        Installer::new_with_external_packages(install_dir.path(), &external_packages);
