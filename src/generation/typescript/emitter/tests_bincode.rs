...
fn struct_with_vec_field_2() {
    ...
    export class Parent {
        ...
        public serialize(serializer: Serializer): void {
            Helpers.serializeVectorVectorChild(this.children, serializer);
        }

        static deserialize(deserializer: Deserializer): Parent {
            const children = Helpers.deserializeVectorVectorChild(deserializer);
...
fn struct_with_option_field() {
    ...
    export class MyStruct {
        ...
        public serialize(serializer: Serializer): void {
            Helpers.serializeOptionStr(this.simple, serializer);
            Helpers.serializeOptionOptionI32(this.nested, serializer);
            Helpers.serializeOptionVectorBool(this.list, serializer);
            Helpers.serializeVectorOptionBool(this.list_of_options, serializer);
        }

        static deserialize(deserializer: Deserializer): MyStruct {
            const simple = Helpers.deserializeOptionStr(deserializer);
            const nested = Helpers.deserializeOptionOptionI32(deserializer);
            const list = Helpers.deserializeOptionVectorBool(deserializer);
            const list_of_options = Helpers.deserializeVectorOptionBool(deserializer);
...
fn struct_with_nested_map_field() {
    ...
    export class MyStruct {
        ...
        public serialize(serializer: Serializer): void {
            ...
            Helpers.serializeVectorMapI32ToStr(this.list_to_map, serializer);
        }

        static deserialize(deserializer: Deserializer): MyStruct {
            const map_to_list = Helpers.deserializeMapStrToVectorI32(deserializer);
            const list_to_map = Helpers.deserializeVectorMapI32ToStr(deserializer);
...
fn struct_with_nested_set_field() {
    ...
    export class MyStruct {
        ...
        public serialize(serializer: Serializer): void {
            ...
            Helpers.serializeSetI32(this.set_of_ints, serializer);
        }

        static deserialize(deserializer: Deserializer): MyStruct {
            const vec_of_sets = Helpers.deserializeVectorSetStr(deserializer);
            const set_of_ints = Helpers.deserializeSetI32(deserializer);
