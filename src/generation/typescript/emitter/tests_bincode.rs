...
fn struct_with_vec_field_2() {
    ...
    assert_struct_serde(&actual, "Parent");
    assert_contains_all(
        &actual,
        &[
            "public children: Seq<Seq<Child>>",
...
fn struct_with_option_field() {
    ...
    assert_contains_all(
        &actual,
        &[
            "public simple: Optional<str>",
            "public nested: Optional<Optional<int32>>",
            "public list: Optional<Seq<bool>>",
            "public list_of_options: Seq<Optional<bool>>",
...
fn struct_with_nested_generics() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "public list_of_optionals: Seq<Optional<int32>>",
            "public map_to_list: Map<str,Seq<bool>>",
            "public optional_map: Optional<Map<str,int32>>",
...
fn struct_with_array_field() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "public string_array: ListTuple<[str]>",
...
fn struct_with_nested_map_field() {
    ...
    assert_contains_all(
        &actual,
        &[
            "public map_to_list: Map<str,Seq<int32>>",
            "public list_to_map: Seq<Map<int32,str>>",
