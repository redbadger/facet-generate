...
//! # use facet_generate::serde_reflection::{Error, Samples, Tracer, TracerConfig};
//! #[derive(Deserialize)]
//! struct Foo {
//!   bar: Bar,
//!   choice: Choice,
...
//! use facet_generate::serde_reflection::{ContainerFormat, Error, Format, Samples, Tracer, TracerConfig};
//!
...
//!
//! ```rust
//! # use facet_generate::serde_reflection::*;
//! # use serde::Serialize;
//! #[derive(Serialize)]
//! struct FullName<'a> {
//!   first: &'a str,
